...
@author: Chris Campell - github.com/ccampell
"""
...
def convert_to_grayscale(gradient):
    """
...
def get_params(example_index):
    ...
    example_list = [['../data/input_images/snake.jpg', 56],
                    ['../data/input_images/cat_dog.png', 243],
                    ['../data/input_images/spider.png', 72]]
